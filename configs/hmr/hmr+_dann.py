...
cache = 'cache1'
cache_files = {
    'h36m': f'data/{cache}/h36m_mosh_train_smpl_54.npz',
    'mpi_inf_3dhp': f'data/{cache}/mpi_inf_3dhp_train_smpl_54.npz',
    'lsp': f'data/{cache}/lsp_train_smpl_54.npz',
    'lspet': f'data/{cache}/lspet_train_smpl_54.npz',
    'mpii': f'data/{cache}/mpii_train_smpl_54.npz',
    'coco': f'data/{cache}/coco_2014_train_smpl_54.npz',
    'gta': f'data/{cache}/gta_human_1x_smpl_54.npz',
